        ...
        <Container>
            <Main>
                <Left>
                    ...
                    <Text>We provide a wide range of courses for the different sectors you can choose from, which suits you perfectly</Text>
                    <Div>
                        <Icon> <BsCheck2Square /></Icon>
                        <Text2>Detail description of each course</Text2>
                    </Div>
                    <Div>
                        <Icon> <BsCheck2Square /></Icon>
                        <Text2>Easy to understand language
